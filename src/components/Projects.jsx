...
const projects = [
    ...
    { name: 'TODAKTODAK', type: 'MOBILE APP', tagline: '작은 위로를 건네는 마음 돌봄 서비스', image: todaktodakImage, imageClass: 'todaktodak', description: '일상 속 감정을 돌아보고 따뜻한 위로를 나눌 수 있도록 만든 마음 돌봄 앱입니다.', skills: ['React Native', 'JavaScript', 'TypeScript'], role: '서비스 화면 UI를 구현하고, 사용자에게 편안하게 다가가는 인터랙션을 고민했습니다.', learning: '기능 구현뿐 아니라 서비스의 분위기와 감정적 경험도 UI/UX의 중요한 일부임을 배웠습니다.', github: 'https://github.com/todagtodag-skhu/Frontend.git' },
]
